...
from GFM_utils import generate_link_prediction_data
...
def main():
    ...
    downstream_root = '/egr/research-dselab/songyu5/Projects/GFM_dev/LLM_data/new'
    ckpt_path = f'./ckpt-5-5/papers_best.ckpt'
